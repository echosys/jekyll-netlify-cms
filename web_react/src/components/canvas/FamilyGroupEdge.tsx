...
const HW            = CARD_W / 2;
const PARENT_DROP   = 20;   // gap below parent bottom → parent bar
const CHILD_RISE    = 20;   // gap above child top  → child bar
...
const STAGGER_STEP  = 16;   // px between stagger slots
