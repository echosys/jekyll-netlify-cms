...
export function makeResource(overrides: Partial<Resource> = {}): Resource {
  return {
    ...
    original_filename: '',
    tags: {
      persons: overrides.tags?.persons ?? [],
      date: overrides.tags?.date ?? null,
      location: overrides.tags?.location ?? null,
      gps: overrides.tags?.gps ?? null,
      custom_tags: overrides.tags?.custom_tags ?? [],
    },
